...
//     // TODO: Все что сверху можжно заменить строками ниже:
//     // std::ifstream inFile("input.txt");
//     // if (inFile.is_open()) {
//     //     Container tempRecords(inFile);
//     // }
//     // inFile.close();
...
//             for (int i = 0; i <= existingRecordsCount; ++i) {
//                 // обращаться через методы: newRecords[i].get_sport()
